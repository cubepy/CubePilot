...
> **نسخهٔ v0.1.6 منتشر شد** — Split View و مدیریت سشن‌ها، برای اندروید و ویندوز. از بخش [Releases](https://github.com/cubepy/CubePilot/releases/latest) بگیرید. هنوز بتاست: برای استفادهٔ روزمره پایدار است ولی آزمایش گسترده نشده. برای باخبر شدن از نسخهٔ بعدی روی Watch 👁 یا Star ⭐ بزنید.
...
سشن‌های چندتبی در یک پنجره · Split View، دو سرور کنار هم یا زیر هم · مدیریت
سشن‌ها · اتصال مجدد خودکار بدون از دست رفتن خروجی · پشتیبانی از ۲۵۶ رنگ ·
...
<details>
<summary><b>مانیتورینگ</b> — <code>v0.1.5</code></summary>

نمایش لحظه‌ای CPU، RAM و دیسک روی داشبورد، به‌همراه Load Average، Uptime، نام
میزبان و توزیع لینوکس — روی همان اتصالی که باز است.

<sub>در برنامه: شبکه · دما · پهنای باند · پینگ · نمودار</sub>
</details>
