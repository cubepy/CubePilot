...
> **نسخهٔ v0.1.16 منتشر شد** — اصلاح حذف سرور و کلید و تونل، برای اندروید و ویندوز. از بخش [Releases](https://github.com/cubepy/CubePilot/releases/latest) بگیرید. هنوز بتاست: برای استفادهٔ روزمره پایدار است ولی آزمایش گسترده نشده. برای باخبر شدن از نسخهٔ بعدی روی Watch 👁 یا Star ⭐ بزنید.
...
<img src="assets/downloads.svg" alt="نمودار دانلودهای CubePilot" width="760">

<sub>از ۲۹ شهریور ۱۴۰۵ روزانه ثبت می‌شود — گیت‌هاب تاریخچهٔ دانلود نگه نمی‌دارد، پس این نمودار از روزی شروع می‌شود که ثبت عددها آغاز شد. <a href="docs/downloads.md">چطور شمرده می‌شود</a></sub>
